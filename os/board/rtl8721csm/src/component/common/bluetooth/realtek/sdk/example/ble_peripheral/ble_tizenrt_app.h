...
typedef enum
{
    ...
    BLE_TIZENRT_CALLBACK_TYPE_PASSKEY_DISPLAY,
...
typedef struct
{
    uint8_t conn_id;
    uint8_t confirm;
} T_TIZENRT_SERVER_PASSKEY_YESNO_PARAM;
...
typedef struct
{
    uint8_t conn_id;
    uint32_t passkey;
} T_TIZENRT_PASSKEY_DISPLAY_PARAM;
